...
## [1.12.7](https://www.nuget.org/packages/GmailHelper/1.12.7) - 2026-08-09
### Changed
- Gmail API dependency update ('1.73.0.4120' -> '1.74.0.4134').

## [1.12.6](https://www.nuget.org/packages/GmailHelper/1.12.6) - 2026-07-26
### Changed
- Gmail API dependency update ('1.73.0.4029' -> '1.73.0.4120').

## [1.12.5](https://www.nuget.org/packages/GmailHelper/1.12.5) - 2026-07-11
### Changed
- MimeKitLite dependency update ('4.15.1' -> '4.16.0').
...
## [1.12.2](https://www.nuget.org/packages/GmailHelper/1.12.2) - 2026-03-01
### Changed
- Gmail API dependency update ('1.73.0.3987' -> '1.73.0.4029').

## [1.12.1](https://www.nuget.org/packages/GmailHelper/1.12.1) - 2026-02-21
### Changed
...
## [1.11.8](https://www.nuget.org/packages/GmailHelper/1.11.8) - 2025-10-27
### Changed
- MimeKitLite dependency update from ('4.13.0' -> '4.14.0').

## [1.11.7](https://www.nuget.org/packages/GmailHelper/1.11.7) - 2025-09-06
### Changed
- Gmail API dependency update ('1.70.0.3819' -> '1.70.0.3833').

## [1.11.6](https://www.nuget.org/packages/GmailHelper/1.11.6) - 2025-07-19
### Changed
- MimeKitLite dependency update from ('4.12.0' -> '4.13.0').

## [1.11.5](https://www.nuget.org/packages/GmailHelper/1.11.5) - 2025-07-07
### Changed
- Gmail API dependency update ('1.69.0.3742' -> '1.70.0.3819').

## [1.11.4](https://www.nuget.org/packages/GmailHelper/1.11.4) - 2025-05-04
### Changed
- MimeKitLite dependency update from ('4.11.0' -> '4.12.0').

## [1.11.3](https://www.nuget.org/packages/GmailHelper/1.11.3) - 2025-04-18
### Changed
- Gmail API dependency update ('1.68.0.3427' -> '1.69.0.3742').
...
## [1.11.1](https://www.nuget.org/packages/GmailHelper/1.11.1) - 2025-02-12
### Changed
...
## [1.9.24](https://www.nuget.org/packages/GmailHelper/1.9.24) - 2024-03-11
### Changed
- MimeKitLite dependency update from ('4.3.0' -> '4.4.0').

## [1.9.23](https://www.nuget.org/packages/GmailHelper/1.9.23) - 2024-03-10
### Changed
- Gmail API dependency update ('1.66.0.3287' -> '1.67.0.3287').

## [1.9.22](https://www.nuget.org/packages/GmailHelper/1.9.22) - 2024-02-19
### Changed
...
## [1.9.19](https://www.nuget.org/packages/GmailHelper/1.9.19) - 2023-11-18
### Changed
- Gmail API dependency update ('1.63.0.3231' -> '1.64.0.3231').

## [1.9.18](https://www.nuget.org/packages/GmailHelper/1.9.18) - 2023-11-16
### Changed
- MimeKitLite dependency update from ('4.2.0' -> '4.3.0').

## [1.9.17](https://www.nuget.org/packages/GmailHelper/1.9.17) - 2023-11-13
### Changed
- Gmail API dependency update ('1.63.0.3217' -> '1.63.0.3231').

## [1.9.16](https://www.nuget.org/packages/GmailHelper/1.9.16) - 2023-11-10
### Changed
- Gmail API dependency update ('1.62.1.3217' -> '1.63.0.3217').

## [1.9.15](https://www.nuget.org/packages/GmailHelper/1.9.15) - 2023-11-05
### Changed
- Gmail API dependency update ('1.62.1.3196' -> '1.62.1.3217').

## [1.9.14](https://www.nuget.org/packages/GmailHelper/1.9.14) - 2023-10-14
### Changed
- Gmail API dependency update ('1.62.1.3189' -> '1.62.1.3196').

## [1.9.13](https://www.nuget.org/packages/GmailHelper/1.9.13) - 2023-10-07
### Changed
- Gmail API dependency update ('1.62.0.3182' -> '1.62.1.3189').

## [1.9.12](https://www.nuget.org/packages/GmailHelper/1.9.12) - 2023-09-30
### Changed
- Gmail API dependency update ('1.62.0.3175' -> '1.62.0.3182').

## [1.9.11](https://www.nuget.org/packages/GmailHelper/1.9.11) - 2023-09-25
### Changed
- Gmail API dependency update ('1.62.0.3105' -> '1.62.0.3175').

## [1.9.10](https://www.nuget.org/packages/GmailHelper/1.9.10) - 2023-09-16
### Changed
- Gmail API dependency update ('1.61.0.3105' -> '1.62.0.3105').

## [1.9.9](https://www.nuget.org/packages/GmailHelper/1.9.9) - 2023-09-10
### Changed
...
## [1.9.4](https://www.nuget.org/packages/GmailHelper/1.9.4) - 2023-06-24
### Changed
- MimeKitLite dependency update from ('4.0.0' -> '4.1.0').

## [1.9.3](https://www.nuget.org/packages/GmailHelper/1.9.3) - 2023-06-20
### Changed
- Gmail API dependency update ('1.60.0.3056' -> '1.60.0.3084').

## [1.9.2](https://www.nuget.org/packages/GmailHelper/1.9.2) - 2023-05-28
### Changed
- Gmail API dependency update ('1.60.0.3035' -> '1.60.0.3056').

## [1.9.1](https://www.nuget.org/packages/GmailHelper/1.9.1) - 2023-05-20
### Changed
...
## [1.8.19](https://www.nuget.org/packages/GmailHelper/1.8.19) - 2023-04-08
### Changed
- MimeKitLite dependency update from ('3.6.0' -> '3.6.1').

## [1.8.18](https://www.nuget.org/packages/GmailHelper/1.8.18) - 2023-04-04
### Changed
- MimeKitLite dependency update from ('3.5.0' -> '3.6.0').

## [1.8.17](https://www.nuget.org/packages/GmailHelper/1.8.17) - 2023-04-01
### Changed
- Gmail API dependency update ('1.59.0.2958' -> '1.60.0.2958').

## [1.8.16](https://www.nuget.org/packages/GmailHelper/1.8.16) - 2023-03-29
### Changed
- Gmail API dependency update ('1.59.0.2944' -> '1.59.0.2958').

## [1.8.15](https://www.nuget.org/packages/GmailHelper/1.8.15) - 2023-03-28
### Changed
